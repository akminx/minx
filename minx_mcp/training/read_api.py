...
class TrainingReadAPI:
    ...
    def get_training_summary(self, date: str) -> TrainingSnapshot:
        ...
        timezone_name = resolve_timezone_name(self._db)
        start_utc, _ = local_day_utc_bounds(start_date, timezone_name)
        _, end_utc = local_day_utc_bounds(date, timezone_name)
